...
test("pending retries reject unsafe or environment-mismatched stored URLs and inconsistent status fields", async () => {
  for (const checkoutUrl of ["http://sandbox.square.link/x", "https://user@sandbox.square.link/x", "https://sandbox.square.link:443/x", "https://evil.sandbox.square.link/x", "https://square.link/x", "https://checkout.square.site/x"]) {
