import { FOUNDER_TIERS } from "./payments/founderOffers.js";
...
export const foundersCampaign = {
  ...
  rewardTiers: FOUNDER_TIERS.map((tier, index) => ({
    offerId: tier.id,
    amountCents: tier.thresholdCents,
    title: tier.name,
    rewards: index === 0 ? [...tier.additionalBenefits] : ["Everything above", ...tier.additionalBenefits],
  })),
};
